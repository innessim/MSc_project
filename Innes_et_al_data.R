...
fig3a <- all_freq_df %>% 
  ...
  ng2 +
  annotate('text', x = 18.8, y = 0.57 , label = 'paste(beta[Cont] == -0.056)',
           parse = TRUE, size = 5) +
  annotate('text', x = 18.5, y = 0.47 , label = 'paste(beta[Hist] == -0.026)',
           parse = TRUE, size = 5) +
  annotate('text', x = 59, y = 0.9 , label = 'italic(P)[Lat~x~time] == 0.861',
           parse = TRUE, size = 5) +
...
fig3b <- all_freq_df %>% 
  ...
  ng2 + 
  annotate('text', x = 18.8, y = 0.57 , label = 'paste(beta[Cont] == -0.028)',
                 parse = TRUE, size = 5) +
  annotate('text', x = 17.9, y = 0.47 , label = 'paste(beta[Hist] == -0.030)',
           parse = TRUE, size = 5) +
  annotate('text', x = 59, y = 0.9 , label = 'italic(P)[Lat~x~time] == 0.278',
           parse = TRUE, size = 5) +
  theme(axis.text.x = element_blank())
...
fig3c <- all_freq_df %>% 
  ...
  annotate('text', x = 19, y = 0.57 , label = 'paste(beta[Cont] == -0.037)',
           parse = TRUE, size = 5) +
  annotate('text', x = 18.6, y = 0.47 , label = 'paste(beta[Hist] == -0.016)',
           parse = TRUE, size = 5) +
  annotate('text', x = 59, y = 0.9 , label = 'italic(P)[Lat~x~time] == 0.707',
           parse = TRUE, size = 5) 
...
fig4a <- all_freq_df %>% 
  ...
  annotate('text', x = -9.8, y = 0.57 , label = 'paste(beta[Cont] == 0.050)',
           parse = TRUE, size = 5) +
  annotate('text', x = -9.9, y = 0.47 , label = 'paste(beta[Hist] == 0.071)',
           parse = TRUE, size = 5) +
  annotate('text', x = -7, y = 0.9 , label = 'italic(P)[MWT~x~time] == 0.167',
           parse = TRUE, size = 5) +
...
fig4b <- all_freq_df %>% 
  ...
  annotate('text', x = -9.9, y = 0.47 , label = 'paste(beta[Hist] == 0.077)',
           parse = TRUE, size = 5) +
  annotate('text', x = -7, y = 0.9 , label = 'italic(P)[MWT~x~time] == 0.072',
           parse = TRUE, size = 5) +
  theme(axis.text.x = element_blank())
...
fig4c <- all_freq_df %>% 
  ...
  annotate('text', x = -9.7, y = 0.47 , label = 'paste(beta[Hist] == 0.052)',
           parse = TRUE, size = 5) +
  annotate('text', x = -7, y = 0.9 , label = 'italic(P)[MWT~x~time] == 0.310',
           parse = TRUE, size = 5)
...
fig4d <- all_freq_df %>%
  ...
  annotate('text', x = -21, y = 0.56 , label = 'paste(beta[Hist] == 0.026)',
           parse = TRUE, size = 5) +
  annotate('text', x = -15, y = 0.9 , label = 'italic(P)[MWT~x~time] == 0.515',
           parse = TRUE, size = 5) +
  theme(plot.title = element_text(hjust = 0.5, size = 17), axis.text.x = element_blank())
...
fig4e <- all_freq_df %>% 
  ...
  ng2 +
  annotate('text', x = -20.85, y = 0.7 , label = 'paste(beta[Cont] == 0.010)',
           parse = TRUE, size = 5) +
  annotate('text', x = -21, y = 0.6 , label = 'paste(beta[Hist] == 0.041)',
           parse = TRUE, size = 5) +
  annotate('text', x = -15, y = 0.9 , label = 'italic(P)[MWT~x~time] == 0.954',
           parse = TRUE, size = 5) +
  theme(axis.text.x = element_blank())
...
fig4f <- all_freq_df %>% 
  ...
  annotate('text', x = -20.8, y = 0.53 , label = 'paste(beta[Hist] == 0.016)',
           parse = TRUE, size = 5) +
  annotate('text', x = -15, y = 0.9 , label = 'italic(P)[MWT~x~time] == 0.665',
           parse = TRUE, size = 5)
